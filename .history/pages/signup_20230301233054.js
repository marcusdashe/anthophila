  ...
  return (
    ...
    <div className="bg-white p-10 rounded-lg shadow-lg">
      ...
      <form>
        ...
        <button onClick = {connectWalletHandler} className="bg-[#492823] w-150 text-white py-3 px-6 rounded-2xl md:mr-3 ml-0 hover:bg-[#D5D0ED] hover:text-[#492823] duration-500 hover:scale-110 duration-500  snm:mr-3">Sign up</button>
      </form>
      <p className='text-[#AE1B1B]'>{error}</p>
    </div>
  </div>
);
}
