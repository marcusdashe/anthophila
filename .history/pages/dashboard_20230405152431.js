  ...
  return (
    <div className="flex">
      ...
      >
        ...
        <div className="flex items-center rounded-md bg-white bg-opacity-60 mt-6 px-4 py-2">
          <SearchIcon
            fontSize="small"
          ...
          <input
            type={"search"}
            placeholder={"Search"}
            className="text-base bg-transparent w-full text-white focus:outline-none p-3"
          />
        </div>
      </div>
