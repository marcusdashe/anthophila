...
const Hero = () => {
  return (
        <div className='bg-gray-100 h-screen flex justify-center items-center flex-col'>
            ...
            <p className='mt-5 fixed bottom-12 md:w-100 sm:w-60'>Do you want to proclaim the death of a testator? <Link className='text-[#5F3EB2] p-2 font-bold rounded-lg hover:bg-[#D5D0ED] duration-500' href={"/proclaimTestatorDeath"}>Family Doctor</Link></p>
        </div>
