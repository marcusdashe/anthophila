...
const Button = ({isPrimary, children}) => {
 console.log(isPrimary)
  return (
    ...
    : 
      <button className="bg-white w-150 text-[#5F3EB2]  border-[3px] border-[#5F3EB2] font-bold py-2 px-6 rounded-2xl md:ml-8 hover:bg-[#D5D0ED] duration-500 hover:border-[.5px] duration-500 hover:bg-[#D5D0ED] hover:text-[#492823] duration-500">
        {children}
      </button>
